...
{
	public class InfixFunctionToken : FunctionToken, IOperation
	{
		#region Fields

		private static readonly Regex __functionPattern = new Regex("^([*]{2}|[/]{2}|[%]{1}){1}", RegexOptions.Compiled | RegexOptions.CultureInvariant);
