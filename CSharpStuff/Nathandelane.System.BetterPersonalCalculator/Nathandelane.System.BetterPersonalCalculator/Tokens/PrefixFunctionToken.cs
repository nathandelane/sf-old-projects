...
namespace Nathandelane.System.BetterPersonalCalculator
{
	public class PrefixFunctionToken : FunctionToken, IOperation
	{
		...
		private static readonly Regex __functionPattern = new Regex("^(cos|sin|tan|acos|asin|atan|sqrt|tod|toh|too|tob|-\\(){1}", RegexOptions.Compiled | RegexOptions.CultureInvariant);
