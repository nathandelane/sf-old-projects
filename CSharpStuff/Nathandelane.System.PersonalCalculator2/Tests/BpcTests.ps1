...
$anyFailed = $False
$numberFailed = 0
$expressions = "12 + 1", "19 - 4", "9 * 8", "13 / 2", "-1 + 2", "-(1 + 2)", "-(-53 + -17)", "21 / 3", "9 // 8", "19 // 8", "21 * 1.5", "2 ** 3", "15 ** 2", "-6 / 2", "-15 / 2", "-15 // 2", "-15 % 2", "100 / 19", "100 // 19", "100 % 19", "(-21 - 1) / 2", "e ** 2", "4 ** 2", "1.5 ** 3", "--mode-degrees tan(45)", "--mode-degrees cos(35)", "--mode-degrees atan(1)"
$expected = 13, 15, 72, 6.5, 1, -3, 70, 7, 1, 2, 31.5, 8, 225, -3, -7.5, -7, -1, 5.26315789473684, 5, 5, -11, 7.38905609893068, 16, 3.375, 1, 0.819152044288992, 45
