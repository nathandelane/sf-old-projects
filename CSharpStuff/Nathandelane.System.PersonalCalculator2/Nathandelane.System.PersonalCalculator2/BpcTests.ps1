...
$anyFailed = $False
$numberFailed = 0
$expressions = "12 + 1 # Simple Addition", "19 - 4 # Simple Subtraction", "9 * 8 # Simple Multiplication", "13 / 2 # Simple Division", "-1 + 2 # Negative Addition", "-(1 + 2) # Negative Distribution", "-(-53 + -17) # More Complex Negative Distribution", "21 / 3 # Simple Division", "9 // 8 # Simple DivRem", "19 // 8 # Simple DivRem", "21 * 1.5 # Decimal Multiplication", "2 ** 3 # Simple Power", "15 ** 2 # Simple Power", "-6 / 2 # Negative Division", "-15 / 2 # Negative Division", "-15 // 2 # Negative DivRem", "-15 % 2 # Negative Modulus", "100 / 19 # Fractional Division", "100 // 19 # Fractional DivRem", "100 % 19 # Fractional Modulus", "(-21 - 1) / 2 # Perentheses", "e ** 2 # E And Power", "4 ** 2 # Simple Power", "1.5 ** 3 # Fractional Power", "--mode-degrees tan(45) # Mode=degrees And Trig", "--mode-degrees cos(35) # Mode=degrees And Trig", "--mode-degrees atan(1) # Mode=degrees And Trig", "pi # PI", "e # E", "4 ** (1 / 2) # Fractional Power", "sqrt(4) # Square Root", "8 ** (1 / 3) # Fractional Power", "4! # Factorial", "16! - 13! # Factorial Subtraction", "((19 + 42 - 12) * 3) ** 2 # Complex Perentheses", "(19 + 42 - 12 * 3) ** 2 # Complex Order of Operations", "todc(ch) # To Decimal on Hexadecimal", "tohx(18) # To Hex on Decimal", "todc(292h + fh) # To Decimal on Hexadecimal Subtraction", "tohx(0.055*255) # Decimal To Hex"
$expected = 13, 15, 72, 6.5, 1, -3, 70, 7, 1, 2, 31.5, 8, 225, -3, -7.5, -7, -1, 5.26315789473684, 5, 5, -11, 7.38905609893068, 16, 3.375, 1, 0.819152044288992, 45, [System.Math]::PI, [System.Math]::E, 2, 2, 2, 24, 20916562867200, 21609, 625, 12, "12h", 673, "eh"
