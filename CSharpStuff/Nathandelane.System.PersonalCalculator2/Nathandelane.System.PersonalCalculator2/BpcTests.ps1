...
$anyFailed = $False
$numberFailed = 0
$expressions = "12 + 1", "19 - 4", "9 * 8", "13 / 2", "-1 + 2", "-(1 + 2)", "-(-53 + -17)", "21 / 3", "9 // 8", "19 // 8", "21 * 1.5", "2 ** 3", "15 ** 2", "-6 / 2", "-15 / 2", "-15 // 2", "-15 % 2", "100 / 19", "100 // 19", "100 % 19", "(-21 - 1) / 2", "e ** 2", "4 ** 2", "1.5 ** 3", "--mode-degrees tan(45)", "--mode-degrees cos(35)", "--mode-degrees atan(1)", "pi", "e", "4 ** (1 / 2)", "sqrt(4)", "8 ** (1 / 3)", "4!", "16! - 13!", "((19 + 42 - 12) * 3) ** 2", "(19 + 42 - 12 * 3) ** 2", "todc(ch)", "tohx(18)", "todc(292h + fh)"
