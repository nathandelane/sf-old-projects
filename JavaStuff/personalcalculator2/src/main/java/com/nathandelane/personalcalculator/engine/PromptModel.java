...
/**
 * Defines how a prompt looks in interactive modes of personal calculator.
 * @author nathanlane
 *
 */
public class PromptModel
{
   ...
   public PromptModel(String prompt) {
      this.prompt = prompt;
   }

   /**
    * Returns a String representation of the prompt model.
    */
   @Override
